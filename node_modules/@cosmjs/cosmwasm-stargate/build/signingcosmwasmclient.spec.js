    ...
    describe("signAndBroadcast", () => {
        describe("direct mode", () => {
            ...
            it("works with auto gas", async () => {
                (0, testutils_spec_1.pendingWithoutWasmd)();
                const wallet = await proto_signing_1.DirectSecp256k1HdWallet.fromMnemonic(testutils_spec_1.alice.mnemonic, { prefix: testutils_spec_1.wasmd.prefix });
                const client = await signingcosmwasmclient_1.SigningCosmWasmClient.connectWithSigner(testutils_spec_1.wasmd.endpoint, wallet, Object.assign(Object.assign({}, testutils_spec_1.defaultSigningClientOptions), { prefix: testutils_spec_1.wasmd.prefix, gasPrice: testutils_spec_1.defaultGasPrice }));
                const msgDelegateTypeUrl = "/cosmos.staking.v1beta1.MsgDelegate";
                const msg = tx_2.MsgDelegate.fromPartial({
                    delegatorAddress: testutils_spec_1.alice.address0,
                    validatorAddress: testutils_spec_1.validator.validatorAddress,
            ...
            it("works with a modifying signer", async () => {
                ...
                expect(Object.assign({}, tx.authInfo.fee.amount[0])).toEqual((0, stargate_1.coin)(3000, "ucosm"));
    ...
    describe("sign", () => {
        describe("direct mode", () => {
            ...
            it("works with a modifying signer", async () => {
                ...
                expect(Object.assign({}, authInfo.fee.amount[0])).toEqual((0, stargate_1.coin)(3000, "ucosm"));
