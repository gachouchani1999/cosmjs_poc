...
async function uploadContract(signer, contract) {
    ...
    const fee = {
        amount: (0, stargate_1.coins)(5000000, "ucosm"),
        gas: "89000000",
    };
...
async function instantiateContract(signer, codeId, beneficiaryAddress, funds) {
    ...
    const theMsg = {
        ...
        value: tx_1.MsgInstantiateContract.fromPartial({
            ...
            label: "my escrow",
            msg: (0, encoding_1.toAscii)(JSON.stringify({
...
async function executeContract(signer, contractAddress, msg) {
    ...
    const theMsg = {
        ...
        value: tx_1.MsgExecuteContract.fromPartial({
            ...
            msg: (0, encoding_1.toAscii)(JSON.stringify(msg)),
            funds: [],
        }),
    };
    const fee = {
...
describe("WasmExtension", () => {
    const hackatom = (0, testutils_spec_1.getHackatom)();
    const hackatomConfigKey = (0, encoding_1.toAscii)("config");
    let hackatomCodeId;
    let hackatomContractAddress;
    beforeAll(async () => {
        if ((0, testutils_spec_1.wasmdEnabled)()) {
            ...
            const instantiateResult = await instantiateContract(wallet, hackatomCodeId, (0, testutils_spec_1.makeRandomAddress)());
            (0, stargate_1.assertIsDeliverTxSuccess)(instantiateResult);
    ...
    describe("listCodeInfo", () => {
        it("has recently uploaded contract as last entry", async () => {
            ...
            (0, utils_1.assert)(hackatomCodeId);
            const client = await (0, testutils_spec_1.makeWasmClient)(testutils_spec_1.wasmd.endpoint);
            const { codeInfos } = await client.wasm.listCodeInfo();
            (0, utils_1.assert)(codeInfos);
            ...
            expect((0, encoding_1.toHex)(lastCode.dataHash)).toEqual((0, encoding_1.toHex)((0, crypto_1.sha256)(hackatom.data)));
        });
    });
    describe("getCode", () => {
        it("contains fill code information", async () => {
            ...
            (0, utils_1.assert)(codeInfo);
            expect(codeInfo.codeId.toNumber()).toEqual(hackatomCodeId);
            expect(codeInfo.creator).toEqual(testutils_spec_1.alice.address0);
            expect((0, encoding_1.toHex)(codeInfo.dataHash)).toEqual((0, encoding_1.toHex)((0, crypto_1.sha256)(hackatom.data)));
    ...
    describe("getContractInfo", () => {
        it("works", async () => {
            ...
            (0, utils_1.assert)(existingContracts);
            ...
            const funds = (0, stargate_1.coins)(707707, "ucosm");
    ...
    describe("getContractCodeHistory", () => {
        it("can list contract history", async () => {
            ...
            (0, utils_1.assert)(history.entries);
    ...
    describe("queryContractRaw", () => {
        it("can query by key", async () => {
            ...
            (0, utils_1.assert)(raw.data, "must get result");
            const model = JSON.parse((0, encoding_1.fromAscii)(raw.data));
        ...
        it("returns empty for missing key", async () => {
            ...
            (0, utils_1.assert)(hackatomContractAddress);
            const client = await (0, testutils_spec_1.makeWasmClient)(testutils_spec_1.wasmd.endpoint);
            const { data } = await client.wasm.queryContractRaw(hackatomContractAddress, (0, encoding_1.fromHex)("cafe0dad"));
    ...
    describe("broadcastTx", () => {
        it("can upload, instantiate and execute wasm", async () => {
            ...
            // upload
            {
                const result = await uploadContract(wallet, (0, testutils_spec_1.getHackatom)());
                (0, stargate_1.assertIsDeliverTxSuccess)(result);
